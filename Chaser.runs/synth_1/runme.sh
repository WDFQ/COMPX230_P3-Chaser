...
HD_PWD='/home/mj547/COMPX230/P3/Chaser/Chaser.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chaser.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chaser.tcl
