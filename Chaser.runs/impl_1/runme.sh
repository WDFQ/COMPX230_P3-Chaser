...
HD_PWD='/home/mj547/COMPX230/P3/Chaser/Chaser.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chaser.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chaser.tcl -notrace
